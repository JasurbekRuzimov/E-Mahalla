...
import uz.ruzimovjasurbek.e_mahalla.databinding.ActivityMainBinding;
import uz.ruzimovjasurbek.e_mahalla.databinding.ActivitySignUpFirebaseBinding;
        ...
        binding.signUpButtonFirebase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phoneNumber.isEmpty()) {
                    binding.phoneNumberIdFirebase.setError("Loginni kiriting !");
                    return;
                }
